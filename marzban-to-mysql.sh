...
step_backup_old_files(){
    ...
    cp /opt/marzban/* ~/marzban-old-files/old-opt/
    mkdir ~/marzban-old-files/old-var
    cp /var/lib/marzban/* ~/marzban-old-files/old-var/
    zip marzban-old-files.zip ~/marzban-old-files
